...
\begin{itemize}[label=$\bullet$]
    ...
    \begin{itemize}[label=$\circ$]
        \item Applied in creating an \textbf{escape room} game in a team of 3 developers
        \item This was done in JavaFX
    \end{itemize}
    \item PostgreSQL
    \item HTML + CSS + Javascript
    \begin{itemize}[label=$\circ$]
        \item Used to create high fidelity prototype - \textbf{"assignment-1-1"} on Github
    \end{itemize}
    \item UI/UX design with Figma
    \begin{itemize}[label=$\circ$]
        \item Used to create high/low fidelity prototypes
    \end{itemize}
...
\begin{itemize}[label=$\bullet$]
    ...
    \begin{itemize}[label=$\circ$]
        \item Applied in \textbf{team projects} in university to achieve success
    \end{itemize}
